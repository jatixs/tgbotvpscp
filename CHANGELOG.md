...
* **Пасхалки и Факты:** Если боту отправить неизвестную команду или текст, он перехватит сообщение и ответит случайным интересным фактом. Встроен переводчик (Google Translate API) для перевода фактов на язык пользователя «на лету».
