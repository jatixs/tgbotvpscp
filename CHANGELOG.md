...
* **Эргономика кнопок:** Системные кнопки («Лайт-версия» и «Для слабовидящих») получили полупрозрачную подложку при активации, а также анимацию вдавливания.
* **Тактильная отдача:** Интегрирована вибрация смартфона при взаимодействии с системными переключателями.

### 🔧 Исправлено:
* **Сохранение темы:** Устранена ошибка в скрипте инициализации (`theme_init.js`), из-за которой выбранная тема (особенно AMOLED) периодически сбрасывалась на светлую при переходах по панели управления.
