...
<p align="center">
  <b>v1.23.2</b> — профессиональная экосистема для мониторинга и управления серверной инфраструктурой<br>
  (Systemd / Docker / API / WebUI / PWA / Multi-Node / Remote SSH / Backup Manager)<br><br>

  <a href="https://github.com/jatixs/tgbotvpscp/releases/latest"><img src="https://img.shields.io/badge/version-v1.23.2-blue?style=flat-square" alt="Version 1.23.2"/></a>
  <a href="https://github.com/jatixs/tgbotvpscp/releases/latest"><img src="https://img.shields.io/badge/build-79-purple?style=flat-square" alt="Build 79"/></a>
