...
Скопируйте и выполните следующую команду, затем выберите нужный пункт меню:
...
Скрипт полностью автоматизирует процесс, предложит выбрать режим установки (Root или Secure), а затем попросит вас ввести:
- `Telegram Bot Token` — токен вашего бота  
- `Telegram User ID` — ваш числовой ID администратора  
...
- 👤 **Непривилегированный пользователь:** запускается от имени `tgbot`  (если выбран не Root - режим).
