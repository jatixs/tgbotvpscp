...
<p align="center">
  <b >v1.10.10</b> — надёжный Telegram-бот для мониторинга и управления вашим VPS или выделенным сервером, теперь с <b>модульной архитектурой</b> и улучшенным процессом развертывания.
</p>

<p align="center">
  <a href="https://github.com/jatixs/tgbotvpscp/releases/latest"><img src="https://img.shields.io/badge/version-1.10.10-blue?style=flat-square" alt="Version 1.10.10"/></a>
  <a href="https://github.com/jatixs/tgbotvpscp/blob/main/CHANGELOG.md"><img src="https://img.shields.io/badge/build-36-purple?style=flat-square" alt="Build 36"/></a>
...
🔄 **Автозапуск и перезапуск:** `systemd`-сервисы обеспечивают надежную работу.
🛡️ **Alert-система:** `watchdog.py` следит за ботом и уведомляет о сбоях.
👤 **Изоляция пользователя (Secure режим):** Бот работает от имени `tgbot`.
🔐 **Конфиденциальность:** `.env` с правами `600`, защищен `.gitignore`.
👮 **Контроль доступа:** Пользователи и группы в `users.json`.

---

## 👤 Автор

**Версия:** 1.10.10 (Build 36)
**Автор:** Jatix
