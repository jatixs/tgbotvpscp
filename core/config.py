...
def load_system_config():
    global TRAFFIC_INTERVAL, BACKUP_INTERVAL, BACKUP_LAST_INTERVAL, SERVICES_INTERVAL, PING_INTERVAL, RESOURCE_CHECK_INTERVAL, MONITORING_INTERVAL, HISTORY_RETENTION_DAYS, CPU_THRESHOLD, RAM_THRESHOLD, DISK_THRESHOLD, RESOURCE_ALERT_COOLDOWN, NODE_OFFLINE_TIMEOUT, WEB_METADATA
    try:
        ...
        if data:
            ...
            MONITORING_INTERVAL = data.get("MONITORING_INTERVAL", DEFAULT_CONFIG["MONITORING_INTERVAL"])
            HISTORY_RETENTION_DAYS = data.get("HISTORY_RETENTION_DAYS", DEFAULT_CONFIG["HISTORY_RETENTION_DAYS"])
...
def save_system_config(new_config: dict):
    global TRAFFIC_INTERVAL, BACKUP_INTERVAL, BACKUP_LAST_INTERVAL, SERVICES_INTERVAL, PING_INTERVAL, RESOURCE_CHECK_INTERVAL, MONITORING_INTERVAL, HISTORY_RETENTION_DAYS, CPU_THRESHOLD, RAM_THRESHOLD, DISK_THRESHOLD, RESOURCE_ALERT_COOLDOWN, NODE_OFFLINE_TIMEOUT, WEB_METADATA  # noqa: F824
    try:
        ...
        if "MONITORING_INTERVAL" in new_config:
            MONITORING_INTERVAL = max(5, int(new_config["MONITORING_INTERVAL"]))
        if "HISTORY_RETENTION_DAYS" in new_config:
            HISTORY_RETENTION_DAYS = max(1, int(new_config["HISTORY_RETENTION_DAYS"]))
