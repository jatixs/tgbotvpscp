...
STRINGS = {
    "ru": {
        ...
        "web_services_btn_stop": "Остановка",
        "web_services_btn_restart": "Перезапуск",
        ...
        "login_insecure_gateway": "Небезопасный шлюз",
        "login_pass_btn": "Вход по паролю",
        "login_back_magic": "Назад к Magic Link",
        "login_or": "ИЛИ",
        "web_telegram_only_tooltip": "Только через Telegram",
        "web_telegram_only_notice": "Включен вход только через Telegram Widget",
        "web_telegram_only_enabled": "Включен режим «Только Telegram». Вход по паролю отключен.",
        "web_telegram_only_disabled": "Режим «Только Telegram» выключен. Все способы входа доступны.",
        "login_btn_back": "Назад",
        "login_support_btn_pay": "Перейти к поддержке (YooMoney)",
        "main_menu_welcome": "👋 Привет! Выбери категорию в меню.",
        "main_menu_return": "📂 Главное меню:",
        ...
        "btn_uptime": "⏱ Аптайм",
        "btn_reset_uptime": "🔄 Сбросить даунтайм",
        "uptime_reset_success": "✅ Даунтайм успешно сброшен к системным значениям!",
        "btn_speedtest": "🚀 Скорость сети",
        "btn_top": "🔥 Топ процессов",
        "btn_xray": "🩻 Обновление X-ray",
        "btn_sshlog": "📜 SSH-лог",
        "btn_fail2ban": "🔒 Журнал Fail2Ban",
        ...
        "btn_client_alerts": "📣 Написать алерт",
        "btn_nodes": "🖥 Ноды",
        "btn_add_user": "➕ Добавить пользователя",
        "btn_delete_user": "➖ Удалить пользователя",
        "btn_change_group": "🔄 Изменить группу",
        "unrecognized_command": "🤖 <b>Неизвестная команда или текст.</b>",
        "unrecognized_command_fact": "🤖 <b>Неизвестная команда!</b> Но раз уж вы здесь, вот интересный факт:\n\n<i>{fact}</i>",
        "btn_selftest_refresh": "🔄 Обновить состояние",
        "selftest_refreshed_alert": "Состояние обновлено!",
        "btn_my_id": "🆔 Мой ID",
        ...
        "alerts_menu_downtime": "{status} Недоступность Нод",
        ...
        "alert_node_down": "🚨 <b>ОПОВЕЩЕНИЕ: Нода '{name}' НЕДОСТУПНА!</b>\n⏱ Последний отклик: {last_seen}",
        "alert_node_up": "✅ <b>Нода '{name}' восстановилась.</b>\n🟢 Снова в сети.",
        ...
        "alert_node_disk_high": "⚠️ <b>Нода '{name}': Мало места на диске!</b>\nЗанято: <b>{usage}%</b> (Порог: {threshold}%)",
        ...
        "alert_disk_high": "⚠️ <b>Превышен порог диска!</b>\nТекущее использование: <b>{usage:.1f}%</b> (Порог: {threshold}%) {processes}",
        "alert_disk_high_repeat": "‼️ <b>Диск всё ещё переполнен!</b>\nТекущее использование: <b>{usage:.1f}%</b> (Порог: {threshold}%) {processes}",
        "alert_disk_normal": "✅ <b>Использование диска нормализовалось.</b>\nТекущее использование: <b>{usage:.1f}%</b>",
        ...
        "btn_node_update_system": "🖥 Обновить систему",
        ...
        "watchdog_status_down_failed": "Статус: ошибка",
        ...
        "f2b_no_bans": "🔒 Нет недавних блокировок IP в логах Fail2Ban.",
        ...
        "optimize_menu_title": "⚡️ <b>Оптимизация системы</b>\n\nВыберите модули для выполнения. Состояние чекбоксов сохраняется для вашего удобства:",
        "opt_cmd_0": "📦 Обновление системы (apt)",
        "opt_cmd_1": "🧹 Очистка кэша (journal, tmp)",
        "opt_cmd_2": "🗑️ Удаление Snapd",
        "opt_cmd_3": "🚀 Установка Preload & ZRAM",
        "opt_cmd_4": "⚙️ Тюнинг Sysctl (BBR, tcp)",
        "opt_cmd_5": "🔒 Тюнинг SSH (UseDNS no)",
        "opt_cmd_6": "🌐 Тюнинг Nginx (workers)",
        "opt_cmd_7": "🔄 Systemd daemon-reexec",
        "opt_btn_exec_all": "🚀 Выполнить полностью",
        "opt_btn_exec_sel": "⚡ Оптимизировать выбранное",
        ...
        "selftest_nodes_all_online": "✅ Все ноды в сети ({online}/{total})",
        "selftest_nodes_some_offline": "⚠️ {online}/{total} нод в сети",
        "selftest_nodes_none": "✅ Мониторинг нод не активен",
        "selftest_target_nodes": "Ноды",
        "selftest_target_agent": "Агент",
        ...
        "btn_memstats_check": "🤖 Проверить потребление бота",
        "callback_stale": "Данные обновились, пожалуйста выберите команду заново",
        "selftest_results_header": "🛠 <b>Состояние сервера:</b>\n\n",
        "selftest_results_body": "📊 Процессор: <b>{cpu_val}</b> (<b>{cpu_bot}</b> из них - бот)\n💾 ОЗУ: <b>{mem_val}</b> (<b>{mem_bot}</b> - бот)\n💽 ПЗУ: <b>{disk_val}</b> (<b>{disk_bot}</b> из них - бот)\n⏱ Время работы: <b>{uptime}</b>\n{inet_status}\n⌛ Задержка ({ping_target}): <b>{ping} мс</b>\n🌐 Внешний IP: <code>{ipv4}</code> / <code>{ipv6}</code>\n📡 Трафик ⬇ <b>{rx}</b> / ⬆ <b>{tx}</b>",
        "node_selftest_results_body": "📊 Процессор: <b>{cpu_val}</b>\n💾 ОЗУ: <b>{mem_val}</b>\n💽 ПЗУ: <b>{disk_val}</b>\n⏱ Время работы: <b>{uptime}</b>\n{inet_status}\n⌛ Задержка ({ping_target}): <b>{ping} мс</b>\n🌐 Внешний IP: <code>{ipv4}</code> / <code>{ipv6}</code>\n📡 Трафик ⬇ <b>{rx}</b> / ⬆ <b>{tx}</b>",
        "speedtest_start": "🚀 <b>Запуск iperf3...</b>\n\nИщу ближайший сервер. Это может занять до 30-40 секунд.",
        "speedtest_results": "🚀 <b>Результаты теста скорости (iperf3):</b>\n\n⬇️ <b>Скачивание:</b> {dl:.2f} Мбит/с\n⬆️ <b>Загрузка:</b> {ul:.2f} Мбит/с\n⏱️ <b>Пинг:</b> {ping:.2f} мс\n\n🌍 <b>Локация:</b> {server}\n🏢 <b>Сервер:</b> {provider}",
        ...
        "speedtest_status_downloading": "🚀 Тестирую скорость на <b>{host}</b> ({ping} мс) ⬇️ Входящий...",
        "speedtest_status_uploading": "🚀 Тестирую скорость на <b>{host}</b> ({ping} мс) ⬆️ Исходящий...",
        "speedtest_progress_ping": "⏱️ Ищу лучший сервер по пингу... ({elapsed}с)",
        "speedtest_progress_downloading": "⬇️ Измеряю входящую скорость... ({elapsed}с)",
        "speedtest_progress_uploading": "⬆️ Измеряю исходящую скорость... ({elapsed}с)",
        "speedtest_progress_ookla": "🚀 Тест скорости (Ookla)... ({elapsed}с)",
        "speedtest_progress_node": "⏳ Тест скорости на ноде <b>{name}</b>... ({elapsed}с)",
        ...
        "sshlog_entry_invalid_user": "❌ <b>Неверный пользователь</b>\n👤 Попытка: <b>{user}</b>\n🌍 IP: <b>{flag} {ip}</b>\n⏰ {time}{tz} ({date})",
        "sshlog_entry_wrong_pass": "❌ <b>Неверный пароль</b>\n👤 Пользователь: <b>{user}</b>\n🌍 IP: <b>{flag} {ip}</b>\n⏰ {time}{tz} ({date})",
        "sshlog_entry_fail_pam": "❌ <b>Провал (PAM)</b>\n👤 Пользователь: <b>{user}</b>\n🌍 IP: <b>{flag} {ip}</b>\n⏰ {time}{tz} ({date})",
        "top_header": "🔥 <b>Топ процессов по загрузке CPU:</b>\n\n{output}",
        "web_theme_label": "Тема",
        "web_vibration_label": "Вибрация",
        "web_hidden_widgets": "Скрытые виджеты",
        "web_hidden_widgets_empty": "Нет скрытых виджетов",
        "web_save_layout": "Сохранить макет",
        "web_widget_size": "Размер",
        "web_widget_hide": "Скрыть",
        "web_widget_restore": "Восстановить",
        "web_system_logs_title": "Системные Логи",
        "top_fail": "❌ Ошибка получения списка процессов:\n<pre>{error}</pre>",
        ...
        "update_confirm": "⚠️ <b>Обновление системы</b>\n\nБудет выполнена команда:\n<code>sudo apt update && sudo apt upgrade -y && sudo apt autoremove -y && sudo apt clean</code>\n\nПродолжить?",
        "btn_confirm_update": "Подтвердить",
        ...
        "vless_success_json_caption": "✅ Файл конфигурации для '<b>{name}</b>' успешно сгенерирован!",
        ...
        "xray_detect_fail": "❌ Не удалось определить поддерживаемый клиент Xray (Marzban, Amnezia, 3X-UI). Обновление невозможно.",
        "xray_detected_start_update": "✅ Обнаружен: <b>{client}</b> (контейнер: <code>{container}</code>).\n\nОбновить Xray?",
        "xray_detected_start_update_native": "✅ Обнаружен: <b>{client}</b>.\n\nОбновить Xray?",
        "btn_confirm_xray_update": "Подтвердить",
        "xray_updating": "🔄 Обновляю {client}... Это может занять пару минут.",
        ...
        "web_node_delete_confirm": "Вы уверены, что хотите удалить эту ноду? Это действие нельзя отменить.",
        "web_billing_modal_title": "Детали аренды",
        "web_billing_amount": "Стоимость аренды:",
        "web_billing_date": "Ближайший платёж:",
        "web_billing_days_left": "Осталось дней: {days}",
        "web_billing_expired": "Просрочено!",
        "web_billing_not_set": "Не установлена",
        "web_billing_bot_hint": "Управлять настройками оплаты можно в Telegram-боте.",
        "web_billing_active_days": "Активен (осталось {days} дней)",
        "web_billing_status_expired": "Просрочен!",
        "web_billing_badge_days": "{days} дней",
        "web_billing_badge_days_short": "{days} д.",
        "web_billing_status": "Статус:",
        "unit_bytes": "Б",
        "unit_kb": "КБ",
        "unit_mb": "МБ",
        "unit_gb": "ГБ",
        ...
        "unit_mbps": "Мбит/с",
        "unit_gbps": "Гбит/с",
        "web_haptics_on": "Тактильная отдача включена",
        "web_haptics_off": "Тактильная отдача отключена",
        "unit_year_short": "г",
        "unit_day_short": "д",
        "unit_hour_short": "ч",
        "unit_minute_short": "м",
        ...
        "web_access_denied_desc": "У вас нет прав для просмотра этой страницы.",
        ...
        "web_notif_downtime_desc": "Оповещать, если нода недоступна",
        "web_notif_resources_desc": "CPU/RAM > 90%",
        "web_notif_logins_desc": "Успешные SSH-подключения",
        ...
        "error_services_interval_low": "Интервал проверки сервисов не может быть меньше 2 секунд.",
        "error_ping_interval_low": "Интервал проверки пинга не может быть меньше 10 секунд.",
        ...
        "web_hint_node_timeout": "Время в секундах, после которого Нода (удалённый сервер) без ответа считается недоступной и отправляется оповещение (минимум 20 сек).",
        ...
        "web_logout": "Выйти",
        "web_reset_uptime": "Сбросить аптайм",
        "web_reset_uptime_confirm": "Вы уверены, что хотите сбросить счетчики аптайма/даунтайма?",
        "web_ip": "IP адрес",
        ...
        "web_perf_mode_on": "Облегчённая версия сайта включена",
        "web_perf_mode_off": "Облегчённая версия сайта отключена",
        "web_a11y_mode_on": "Режим для слабовидящих включен",
        "web_a11y_mode_off": "Режим для слабовидящих отключен",
        "web_toggle_perf_mode": "Переключить облегчённый режим",
        "web_toggle_a11y_mode": "Переключить режим для слабовидящих",
        "web_edit_ui": "Редактировать интерфейс",
        "web_help_hotkeys": "Справка / горячие клавиши",
        "web_vnc_terminal_title": "VNC / Терминал",
        "web_on": "Вкл",
        "web_off": "Выкл",
        ...
        "login_webapp_auth_failed": "Ошибка авторизации через Web App",
        "login_webapp_auth_error": "Ошибка авторизации Web App",
        ...
        "web_nodes_monitor_filter_online": "В сети",
        "web_nodes_monitor_filter_offline": "Не в сети",
        ...
        "web_nodes_monitor_filter_sort_custom": "Вручную",
        ...
        "web_nodes_monitor_online": "В сети",
        "web_nodes_monitor_offline": "Не в сети",
        "web_nodes_monitor_cpu": "ЦП",
        "web_nodes_monitor_ram": "ОЗУ",
        ...
        "web_nodes_monitor_btn_speedtest": "Тест скорости",
        ...
        "web_nodes_monitor_service_stop": "Остановка",
        "web_nodes_monitor_service_restart": "Перезапуск",
        ...
        "web_commands_sent": "Команды отправлены на выбранные ноды",
        "web_reboot_sent": "Команда перезагрузки отправлена",
        "web_node_modal_loading": "Загрузка...",
        ...
        "web_notif_source_agent": "Агент",
        "web_notif_source_node": "Нода",
        "web_notif_node_label": "Нода",
        ...
        "web_ping_error_title": "Ошибка: пинг не возможен",
        "web_ping_error_desc": "Система не смогла измерить сетевую задержку ни основным, ни резервным методом.",
        "web_ping_how_to_fix_btn": "Как исправить?",
        "web_ping_fix_tcp": "Выбран режим <b>TCP</b>.<br><br>1. Убедитесь, что фаервол вашего провайдера не блокирует исходящий трафик на порт <b>53</b>.<br>2. Убедитесь, что утилита <code>ping</code> установлена (система пыталась сделать фолбек на ICMP, но он тоже не сработал).",
        "web_ping_fix_http": "Выбран режим <b>HTTP</b>.<br><br>1. Убедитесь, что сервер имеет выход в интернет (порт <b>443</b>).<br>2. Убедитесь, что утилита <code>ping</code> установлена (система пыталась сделать фолбек на ICMP, но он тоже не сработал).",
        "web_ping_target_title": "Цель пинга",
        "web_ping_target_internal": "Внутренняя сеть",
        "web_ping_target_internal_desc": "Пинг до ваших нод",
        ...
        "billing_change_currency": "Изменить валюту",
        "billing_currency_eur": "Евро (€)",
        "billing_currency_usd": "Доллар ($)",
        "billing_currency_rub": "Рубль (₽)",
        "billing_currency_success": "Валюта изменена на {currency}!",
        ...
        "btn_billing": "💳 Биллинг",
        "billing_toggle_reminder": "Уведомление об оплате",
        "billing_date_not_set": "Не установлена",
        "billing_free": "Бесплатно",
        "billing_date_past_error": "Дата не может быть в прошлом. Введите дату не раньше сегодняшней.",
        "billing_menu_text": "💳 <b>{name}</b>\n\n💰 <b>Сумма к оплате:</b> {amount}\n📅 <b>Дата оплаты:</b> {date}",
        ...
        "alert_btn_settings": "⚙️ Настройки",
        "alert_welcome_new": "👋 Добро пожаловать!\n\nВы подписались на уведомления от администратора.\n⚠️ <b>Внимание:</b> писать боту можно только <b>в ответ</b> на сообщения от администратора (используйте функцию Telegram «Ответить» / «Reply»).\nОбычные сообщения бот не принимает.",
        "alert_welcome_existing": "✅ Вы уже подписаны на уведомления.\n⚠️ Напоминаем: чтобы написать нам, используйте функцию «Ответить» на любое сообщение от администратора.",
        "alert_settings_text": "⚙️ <b>Настройки уведомлений</b>\n\nЗдесь вы можете выбрать, от каких серверов получать автоматические системные уведомления.",
        "alert_reply_error_not_reply": "⚠️ Ошибка: пожалуйста, используйте функцию <b>«Ответить»</b> (Reply) на сообщение от администратора, чтобы мы получили ваш ответ.",
        "alert_reply_error_self": "⚠️ Ошибка: Вы ответили на своё собственное сообщение. Пожалуйста, ответьте на сообщение от администратора.",
        "alert_reply_error_bot": "⚠️ Ошибка: Вы ответили на системное сообщение бота. Пожалуйста, ответьте на сообщение от администратора.",
        "alert_flood_wait": "⏳ Пожалуйста, подождите несколько секунд перед отправкой следующего сообщения.",
        "alert_msg_sent": "✅ Сообщение отправлено.",
        "alert_btn_notifications_disabled": "🔕 Уведомления отключены (Вкл)",
        "alert_btn_notifications_enabled": "🔔 Уведомления включены (Выкл)",
        "node_btn_alert_bot": "Alert Bot",
        "btn_page_prev": "⬅️",
        "btn_page_next": "➡️",
        "node_page_prev": "⬅️ Назад к Мониторингу",
        "node_page_next": "➡️ Настройки и Управление",
    },
    ...
    "en": {
        ...
        "btn_client_alerts": "📣 Write Alert",
        "btn_nodes": "🖥 Nodes",
        "btn_add_user": "➕ Add User",
        "btn_delete_user": "➖ Delete User",
        "btn_change_group": "🔄 Change Group",
        "unrecognized_command": "🤖 <b>Unknown command or text.</b>",
        "unrecognized_command_fact": "🤖 <b>Unknown command!</b> But since you're here, here's an interesting fact:\n\n<i>{fact}</i>",
        "btn_selftest_refresh": "🔄 Update status",
        "selftest_refreshed_alert": "Status updated!",
        "btn_my_id": "🆔 My ID",
        "delete_user_button_text": "{user_name} ({group})",
        ...
        "btn_node_update_system": "🖥 Update system",
        ...
        "f2b_no_bans": "🔒 No recent IP bans found in Fail2Ban logs.",
        ...
        "optimize_menu_title": "⚡️ <b>System Optimization</b>\n\nSelect modules to execute. Your choices are saved for convenience:",
        "opt_cmd_0": "📦 System update (apt)",
        "opt_cmd_1": "🧹 Cache cleanup (journal, tmp)",
        "opt_cmd_2": "🗑️ Remove Snapd",
        "opt_cmd_3": "🚀 Install Preload & ZRAM",
        "opt_cmd_4": "⚙️ Sysctl Tuning (BBR, tcp)",
        "opt_cmd_5": "🔒 SSH Tuning (UseDNS no)",
        "opt_cmd_6": "🌐 Nginx Tuning (workers)",
        "opt_cmd_7": "🔄 Systemd daemon-reexec",
        "opt_btn_exec_all": "🚀 Execute All",
        "opt_btn_exec_sel": "⚡ Optimize Selected",
        ...
        "selftest_nodes_all_online": "✅ All nodes online ({online}/{total})",
        "selftest_nodes_some_offline": "⚠️ {online}/{total} nodes online",
        "selftest_nodes_none": "✅ Node monitoring not active",
        "selftest_target_nodes": "Nodes",
        "selftest_target_agent": "Agent",
        ...
        "btn_memstats_check": "🤖 Check Bot RAM usage",
        "callback_stale": "Data updated, please select the command again",
        "selftest_results_header": "🛠 <b>Server Status:</b>\n\n",
        "selftest_results_body": "📊 CPU: <b>{cpu_val}</b> (<b>{cpu_bot}</b> used by bot)\n💾 RAM: <b>{mem_val}</b> (<b>{mem_bot}</b> - bot)\n💽 Disk: <b>{disk_val}</b> (<b>{disk_bot}</b> used by bot)\n⏱ Uptime: <b>{uptime}</b>\n{inet_status}\n⌛ Ping ({ping_target}): <b>{ping} ms</b>\n🌐 External IP: <code>{ipv4}</code> / <code>{ipv6}</code>\n📡 Traffic ⬇ <b>{rx}</b> / ⬆ <b>{tx}</b>",
        "node_selftest_results_body": "📊 CPU: <b>{cpu_val}</b>\n💾 RAM: <b>{mem_val}</b>\n💽 Disk: <b>{disk_val}</b>\n⏱ Uptime: <b>{uptime}</b>\n{inet_status}\n⌛ Ping ({ping_target}): <b>{ping} ms</b>\n🌐 External IP: <code>{ipv4}</code> / <code>{ipv6}</code>\n📡 Traffic ⬇ <b>{rx}</b> / ⬆ <b>{tx}</b>",
        ...
        "speedtest_status_downloading": "🚀 Testing speed on <b>{host}</b> ({ping} ms) ⬇️ Download...",
        "speedtest_status_uploading": "🚀 Testing speed on <b>{host}</b> ({ping} ms) ⬆️ Upload...",
        "speedtest_progress_ping": "⏱️ Finding the best server by ping... ({elapsed}s)",
        "speedtest_progress_downloading": "⬇️ Measuring download speed... ({elapsed}s)",
        "speedtest_progress_uploading": "⬆️ Measuring upload speed... ({elapsed}s)",
        "speedtest_progress_ookla": "🚀 Ookla Speedtest... ({elapsed}s)",
        "speedtest_progress_node": "⏳ Speedtest on node <b>{name}</b>... ({elapsed}s)",
        ...
        "top_header": "🔥 <b>Top processes by CPU load:</b>\n\n{output}",
        ...
        "update_confirm": "⚠️ <b>System Update</b>\n\nThe following command will be executed:\n<code>sudo apt update && sudo apt upgrade -y && sudo apt autoremove -y && sudo apt clean</code>\n\nContinue?",
        ...
        "vless_prompt_file": "📤 <b>Send your Xray configuration file (JSON) OR a vless:// link</b>\n\n<i>Important: The JSON file must contain a working outbound configuration with Reality. A link will be converted to a JSON config for import.</i>",
        ...
        "vless_success_json_caption": "✅ JSON configuration for '<b>{name}</b>' successfully generated!",
        ...
        "xray_detect_fail": "❌ Could not detect a supported Xray client (Marzban, Amnezia, 3X-UI). Update aborted.",
        "xray_detected_start_update": "✅ Detected: <b>{client}</b> (container: <code>{container}</code>).\n\nUpdate Xray?",
        "xray_detected_start_update_native": "✅ Detected: <b>{client}</b>.\n\nUpdate Xray?",
        "btn_confirm_xray_update": "Confirm",
        "xray_updating": "🔄 Updating {client}... This may take a few minutes.",
        ...
        "web_node_delete_confirm": "Are you sure you want to delete this node? This action cannot be undone.",
        "web_billing_modal_title": "Rental Details",
        "web_billing_amount": "Rental cost:",
        "web_billing_date": "Next payment:",
        "web_billing_days_left": "Days left: {days}",
        "web_billing_expired": "Expired!",
        "web_billing_not_set": "Not set",
        "web_billing_bot_hint": "You can manage billing settings in the Telegram bot.",
        "web_billing_active_days": "Active ({days} days left)",
        "web_billing_status_expired": "Expired!",
        "web_billing_badge_days": "{days} days",
        "web_billing_badge_days_short": "{days} d.",
        "web_billing_status": "Status:",
        "unit_bytes": "B",
        "unit_kb": "KB",
        "unit_mb": "MB",
        "unit_gb": "GB",
        ...
        "unit_mbps": "Mbps",
        "unit_gbps": "Gbps",
        "web_haptics_on": "Haptic feedback enabled",
        "web_haptics_off": "Haptic feedback disabled",
        "unit_year_short": "y",
        "unit_day_short": "d",
        "unit_hour_short": "h",
        "unit_minute_short": "m",
        ...
        "web_theme_label": "Theme",
        "web_vibration_label": "Vibration",
        "web_hidden_widgets": "Hidden Widgets",
        "web_hidden_widgets_empty": "No hidden widgets",
        "web_save_layout": "Save Layout",
        "web_widget_size": "Size",
        "web_widget_hide": "Hide",
        "web_widget_restore": "Restore",
        "web_system_logs_title": "System Logs",
        "web_add_ip": "Add IP",
        ...
        "web_monitor_btn": "Monitor",
        "web_monitor_title": "Open Nodes Monitor",
        ...
        "web_access_denied_desc": "You do not have permission to view this page.",
        ...
        "web_notif_downtime_desc": "Notify when node goes offline",
        "web_notif_resources_desc": "CPU/RAM > 90%",
        "web_notif_logins_desc": "Successful SSH connections",
        ...
        "error_services_interval_low": "Services check interval cannot be less than 2 seconds.",
        "error_ping_interval_low": "Ping check interval cannot be less than 10 seconds.",
        ...
        "web_logout": "Logout",
        "web_reset_uptime": "Reset Uptime",
        "web_reset_uptime_confirm": "Are you sure you want to reset the uptime/downtime counters?",
        ...
        "web_ping_target_title": "Ping Target",
        "web_ping_target_internal": "Internal network",
        "web_ping_target_internal_desc": "Ping to your nodes",
        "web_ping_target_no_nodes": "No active nodes available for this mode",
        "web_apply": "Apply",
        "web_ip": "IP Address",
        "web_device": "Device",
        ...
        "login_insecure_gateway": "Insecure Gateway",
        ...
        "web_perf_mode_on": "Lite version enabled",
        "web_perf_mode_off": "Lite version disabled",
        "web_a11y_mode_on": "Visually impaired mode enabled",
        "web_a11y_mode_off": "Visually impaired mode disabled",
        "web_toggle_perf_mode": "Toggle light mode",
        "web_toggle_a11y_mode": "Toggle accessibility mode",
        "web_edit_ui": "Edit UI",
        "web_help_hotkeys": "Help / Hotkeys",
        "web_vnc_terminal_title": "VNC / Terminal",
        "web_on": "On",
        "web_off": "Off",
        "web_server_rebooting": "The server/bot has rebooted.",
        ...
        "login_webapp_auth_failed": "Web App auth failed",
        "login_webapp_auth_error": "Web App Auth Error",
        ...
        "web_nodes_monitor_filter_sort_custom": "Custom order",
        ...
        "web_commands_sent": "Commands sent to all selected nodes",
        "web_reboot_sent": "Reboot command sent",
        "web_node_modal_loading": "Loading...",
        ...
        "web_notif_source_agent": "Agent",
        "web_notif_source_node": "Node",
        "web_notif_node_label": "Node",
        ...
        "web_ping_error_title": "Error: ping unavailable",
        "web_ping_error_desc": "The system could not measure network latency using primary or fallback methods.",
        "web_ping_how_to_fix_btn": "How to fix?",
        "web_ping_fix_tcp": "<b>TCP</b> mode is selected.<br><br>1. Ensure your provider's firewall does not block outbound traffic to port <b>53</b>.<br>2. Make sure the <code>ping</code> utility is installed (the system tried an ICMP fallback, but it also failed).",
        "web_ping_fix_http": "<b>HTTP</b> mode is selected.<br><br>1. Ensure the server has internet access (port <b>443</b>).<br>2. Make sure the <code>ping</code> utility is installed (the system tried an ICMP fallback, but it also failed).",
        "billing_setup": "Setup billing",
        "billing_change_amount": "Change amount",
        "billing_change_currency": "Change currency",
        "billing_currency_eur": "Euro (€)",
        "billing_currency_usd": "Dollar ($)",
        "billing_currency_rub": "Ruble (₽)",
        "billing_currency_success": "Currency changed to {currency}!",
        ...
        "btn_billing": "💳 Billing",
        "billing_toggle_reminder": "Payment Reminder",
        "billing_date_not_set": "Not set",
        "billing_free": "Free",
        "billing_date_past_error": "Date cannot be in the past. Please enter a date starting from today.",
        ...
        "alert_btn_settings": "⚙️ Settings",
        "alert_welcome_new": "👋 Welcome!\n\nYou are now subscribed to admin notifications.\n⚠️ <b>Attention:</b> You can only write to this bot <b>in reply</b> to messages from the admin (use Telegram's «Reply» feature).\nThe bot does not accept regular messages.",
        "alert_welcome_existing": "✅ You are already subscribed to notifications.\n⚠️ Reminder: to write to us, use the «Reply» function on any message from the admin.",
        "alert_settings_text": "⚙️ <b>Notification Settings</b>\n\nHere you can choose which servers to receive automated system notifications from.",
        "alert_reply_error_not_reply": "⚠️ Error: please use the <b>«Reply»</b> function on a message from the admin so we can receive your response.",
        "alert_reply_error_self": "⚠️ Error: You replied to your own message. Please reply to a message from the admin.",
        "alert_reply_error_bot": "⚠️ Error: You replied to a system bot message. Please reply to a message from the admin.",
        "alert_flood_wait": "⏳ Please wait a few seconds before sending the next message.",
        "alert_msg_sent": "✅ Message sent.",
        "alert_btn_notifications_disabled": "🔕 Notifications Disabled (Turn On)",
        "alert_btn_notifications_enabled": "🔔 Notifications Enabled (Turn Off)",
        "node_btn_alert_bot": "Alert Bot",
        "btn_page_prev": "⬅️",
        "btn_page_next": "➡️",
        "node_page_prev": "⬅️ Back to Monitoring",
        "node_page_next": "➡️ Settings & Management",
    },
}
...
LOG_STRINGS = {
    "en": {
        ...
        "translate_google_error": "Google Translate error (status {status}). Attempting translation via MyMemory API...",
        "translate_mymemory_error": "MyMemory API error (status {status})",
        "translate_error": "Translation API error: {error}",
    },
    "ru": {
        ...
        "translate_google_error": "Ошибка перевода через Google Translate (статус {status}). Попытка перевода через MyMemory API...",
        "translate_mymemory_error": "Ошибка MyMemory API (статус {status})",
        "translate_error": "Общая ошибка API перевода: {error}",
    },
}
