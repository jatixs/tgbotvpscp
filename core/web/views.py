...
async def handle_settings_page(request: web.Request) -> web.StreamResponse:
    ...
    context = {
        ...
        "val_ping": str(current_config.PING_INTERVAL),
        "val_ping_method": str(getattr(current_config, "PING_METHOD", "HTTP")),
        "val_timeout": str(getattr(current_config, "NODE_OFFLINE_TIMEOUT", 20)),
