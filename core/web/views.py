...
async def handle_settings_page(request: web.Request) -> web.StreamResponse:
    ...
    i18n_data = {
        ...
        "web_clear_history_confirm": _("web_clear_history_confirm", lang),
        "web_history_cleared": _("web_history_cleared", lang),
        "web_clear_history_btn": _("web_clear_history_btn", lang),
    ...
    context = {
        ...
        "val_monitoring_interval": str(getattr(current_config, "MONITORING_INTERVAL", 5)),
        "val_history_days": str(getattr(current_config, "HISTORY_RETENTION_DAYS", 1)),
        ...
        "web_monitoring_interval": _("web_monitoring_interval", lang),
        "web_history_retention_days": _("web_history_retention_days", lang),
        "web_node_timeout": _("web_node_timeout", lang),
        "web_hint_monitoring_interval": _("web_hint_monitoring_interval", lang),
        "web_hint_history_retention": _("web_hint_history_retention", lang),
        "web_clear_history_btn": _("web_clear_history_btn", lang),
        "web_clear_logs_btn": _("web_clear_logs_btn", lang),
        "web_reset_traffic_btn": _("web_reset_traffic_btn", lang),
